...
if (is_admin()) {
    require_once WP_PUBLICATIONS_PLUGIN_DIR . 'admin/admin-menu.php';
    require_once WP_PUBLICATIONS_PLUGIN_DIR . 'admin/import-page.php';
    require_once WP_PUBLICATIONS_PLUGIN_DIR . 'admin/settings-page.php';
}
...
function wp_publications_admin_enqueue($hook) {
    ...
    wp_localize_script('wp-publications-admin', 'wpPublications', array(
